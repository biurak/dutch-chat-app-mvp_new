...
export default function HomePage() {
	// Set to true by default for preview purposes
	const [isOnboardingOpen, setOnboardingOpen] = useState(true)

	useEffect(() => {
		// In a real app, this logic would control the modal's visibility
			...
			<div className='flex flex-col items-center min-h-screen bg-gradient-to-br from-sky-50 to-sky-100 p-4 pt-8 md:pt-16'>
				<header className='mb-8 text-center'>
					...
					<p className='text-lg text-slate-600'>
						Practice your Dutch with an AI conversation partner!
					</p>
				</header>
							...
							return (
								...
								>
									...
									<CardContent className='text-center flex-grow'>
										<CardDescription className='text-sm text-slate-500 min-h-[3em]'>
											{topic.description}
										</CardDescription>
									</CardContent>
									<CardFooter>
